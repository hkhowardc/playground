...
from iris import create_iris_train_test_csv_files, species_name_to_int, IRIS_COLUMNS
...
def iris_csv_input_fn(csv_file_path, mini_batch_size, num_epochs,
    ...
    def _gen_features_and_labels_from_file():
        with open(csv_file_path, mode="r") as f:
            for sample_dict in csv.DictReader(f, fieldnames=IRIS_COLUMNS):
                features = {
...
if __name__ == '__main__':
    ...
    model_dir = "./models/iris_csv_dataset/" + ts
